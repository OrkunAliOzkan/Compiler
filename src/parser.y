...
%token CONDITIONAL_LT CONDITIONAL_LTE CONDITIONAL_GT CONDITIONAL_GTE CONDITIONAL_EQ
%token ARITHMETIC_PLUS ARITHMETIC_SUB ARITHMETIC_DIV ARITHMETIC_EQ
%token TYPE_POINT TYPE_REF
